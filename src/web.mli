...
val make_request : Httpaf.Method.t -> string -> (string * string) list -> string option -> http_request
...
val middleware_combine : 'a web_server -> 'a web_server -> 'a http_context -> 'a http_context option Lwt.t
...
val make_cust_router : (Httpaf.Method.t * string * 'a web_server) list -> 'a -> 'b -> Httpaf.Reqd.t -> unit
